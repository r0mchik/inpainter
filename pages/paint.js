    ...
    <div>
      ...
      <main className="container mx-auto p-5">
	    ...
	    <ol className="list-decimal pl-5">
            <li className="mb-2">
            Введите текстовые подстказки чтобы сгенерировать изображение  или з		агрузите свое изображение..
            </li>
            <li className="mb-2">
            Вы можете закрасить место которое хотите изменить.
            </li>
            <li className="mb-2">
                Напишите то что бы хотели видеть на закрашенном месте или ничего не изменяйте если хотите чтобы модель сгенерировала новые объекты в том же стиле.
            </li>
            </ol> 
          </div>
        </div>
