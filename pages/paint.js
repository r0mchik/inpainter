    ...
    <div>
      ...
      <main className="container mx-auto p-5">
	    ...
	    <ol className="list-decimal pl-5">
            ...
            <li className="mb-2">
            Закрасьие место которое хотите изменить.
            </li>
            <li className="mb-2">
            Напишите то, что бы вы хотели видеть на закрашенном месте или не изменяйте текст если нужен тот же объект но в другом виде.
            </li>
            </ol> 
          </div>
        </div>
